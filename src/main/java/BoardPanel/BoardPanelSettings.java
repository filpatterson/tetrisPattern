...
public class BoardPanelSettings {
     ...
     */
    public static final Integer COLOR_MIN = 35;

    /**
     * Maximum color component that can be used for setting shading and light
     */
    public static final Integer COLOR_MAX = 255 - COLOR_MIN;

    /**
     * Limit of width for border around the game board
     */
    public static final Integer BORDER_WIDTH = 5;
     ...
     */
    public static final Integer VISIBLE_ROW_COUNT = 20;
     ...
     */
    public static final Integer HIDDEN_ROW_COUNT = 2;

    /**
     * Total amount of all rows on game field
     */
    public static final Integer ROW_COUNT = VISIBLE_ROW_COUNT + HIDDEN_ROW_COUNT;

    /**
     * Any figure requires setting size of it's drawing in pixels.
     * Amount of pixels for drawing tile on screen
     */
    public static final Integer TILE_SIZE_PIXELS = 24;

    /**
     * Tiles requires shading (looks better).
     * Amount of pixels for shading
     */
    public static final Integer SHADE_SIZE_PIXELS = 4;

    /**
     * X-axis center of game board
     */
    public static final Integer CENTER_X = COL_COUNT * TILE_SIZE_PIXELS / 2;

    /**
     * Y-axis center of game board
     */
    public static final Integer CENTER_Y = VISIBLE_ROW_COUNT * TILE_SIZE_PIXELS / 2;

    /**
     * Total height of the game panel
     */
    public static final Integer PANEL_WIDTH = COL_COUNT * TILE_SIZE_PIXELS + BORDER_WIDTH * 2;

    /**
     * Total width of the game panel
     */
    public static final Integer PANEL_HEIGHT = VISIBLE_ROW_COUNT * TILE_SIZE_PIXELS + BORDER_WIDTH * 2;
